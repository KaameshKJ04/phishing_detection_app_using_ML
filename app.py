...
st.title('Phishing Website Detection using Machine Learning BY Deeraj G R')
...
with st.expander("PROJECT DETAILS"):
    ...
    st.write('https://github.com/deerajgr/DETECTING-PHISHING-WEBSITES-USING-MACHINE-LEARNING.git')
